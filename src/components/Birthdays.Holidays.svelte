<script>
	...
	$: christmas = birthdays.filter(({ birthday }) => birthday === "2024-12-25");

	$: halloween = birthdays.filter(({ birthday }) => birthday === "2024-10-31");

	$: newyears = birthdays.filter(({ birthday }) => birthday === "2024-01-01");
